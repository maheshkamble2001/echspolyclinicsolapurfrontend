  ...
  return (
    <Element
      ...
      className={clsx(
        ...
        isActive
          ? "dark:bg-primary-400/15 dark:text-primary-400 text-[#EB1F23]"
          : "focus:bg-primary-600/20 dark:text-dark-200 dark:hover:bg-dark-300/20 dark:focus:bg-dark-300/20 dark:active:bg-dark-300/25 text-gray-500",
      )}
    ...
    >
      {Icon && (
        <Icon className="size-7 transition-colors duration-300 hover:text-[#EB1F23]" />
      )}
